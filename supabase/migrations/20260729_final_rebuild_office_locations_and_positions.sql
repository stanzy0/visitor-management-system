-- Migration: Complete rebuild of office_locations and finalize positions independence
-- Date: 2026-07-29
-- Description: Delete corrupted office_locations, rebuild with correct departments, and ensure positions has no department column

-- =============================================================================
-- Ensure positions table is independent (remove department column if it still exists)
-- =============================================================================
...
-- Verify office_locations distribution
