    ...
    return (
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm p-8 text-center">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left text-sm">
          ...
          <p className="text-blue-700">Date: {invitation.expected_date}</p>
          <p className="text-blue-700">Time: {invitation.expected_time || 'TBD'}</p>
          <p className="text-blue-700">Host: {invitation.host.full_name}</p>
          <p className="text-blue-700">Purpose: {invitation.purpose}</p>
        </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          disabled={loading}
          className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-md shadow-blue-500/20 hover:shadow-lg hover:shadow-blue-500/30 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100 transition-all duration-200"
        >
